...
const regitser = (DID,PID,apptID,Date) => {
    ...
    }).then((response) => 
    {
      ...
      toast.success('Prescriped!', {position: toast.POSITION.TOP_RIGHT});
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white bg-opacity-40 outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                  <form className="bg-gray-200 bg-opacity-80 shadow-md rounded px-8 pt-6 pb-8 w-full">
                    ...
                    <input type="text" required placeholder="Limit: 100 characters" maxLength={100} className="shadow appearance-none  border rounded w-full py-2 px-1 text-black" onChange={(e) => {setmedName(e.target.value)}}/>
                    <label className="block text-black text-sm font-bold mb-1">
                      Dosage
                    </label>
                    <input type="text" required placeholder="Limit: 100 characters" maxLength={100} className="shadow appearance-none border rounded w-full py-2 px-1 text-black" onChange={(e) => {setdosage(e.target.value)}}/>
                    <label className="block text-black text-sm font-bold mb-1">
                      Diagnosis
                    </label>
                    <input type="text" required placeholder="Limit: 300 characters" maxLength={300} className="shadow appearance-none border rounded w-full py-2 px-1 text-black" onChange={(e) => {setdiagnosis(e.target.value)}}/>
