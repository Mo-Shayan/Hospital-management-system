...
const PDoctorList = (props) => {
  ...
  const BookAppointment = (DocID, deptID, index) => {
    ...
    toast.success('Appointment Booked!', {position: toast.POSITION.TOP_RIGHT});
                ...
                <div className="flex flex-col  w-24 h-13 border-solid border-2 border-indigo-300 rounded font-bold shadow">
                  <input
                    ...
                    onChange={(e) => {
                        ...
                        // Or you can show the error message in a more user-friendly way, like displaying it next to the input field
                         // Reset the input value to prevent the user from
